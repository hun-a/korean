...
export const drawGuideText = (canvas, targetText) => {
  ...
  context.font = '220px Gaegu, sans-serif';
  context.textAlign = 'center';
  context.textBaseline = 'middle';
  context.fillStyle = 'rgba(14, 77, 146, 0.25)';
  context.fillText(targetText, CANVAS_SIZE / 2, CANVAS_SIZE / 2 + 20);
};
...
export const getCanvasScore = (drawingCanvas, targetText) => {
  ...
  targetContext.font = '220px Gaegu, sans-serif';
